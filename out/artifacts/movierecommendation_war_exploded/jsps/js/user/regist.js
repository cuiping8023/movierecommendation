$(function(){
	...
	$(".errorClass").each(function(){
		showError($(this));//1  遍历每个元素，使每个元素来调用showError方法
	...
	$(".inputClass").blur(function(){
		...
		var funName = "validate"+id.substring(0,1).toUpperCase()+id.substring(1)+"()";//得到对应的调用函数名
		eval(funName);//执行函数调用
	});
